...
if (filterBy === "Group") {
  ...
  ApplicationContext.set('registerFilter', items[0].filterValue);
  ...
  ApplicationContext.set('categoryFilter', items[0].filterValue);
...
if (Utils.isDefined(loProductQuickFilter)) {
  ...
  currentAppliedGroup = loProductQuickFilter.getItemsByParam({"filterValue": items[0].filterValue});
}
...
if (items[0].specialOption !== "CLEAR") {
  ...
  if (filterBy === "Group") {
    ...
    me.setGroupQuickFilterCache(items[0].filterValue);
  }
  else if (filterBy === "Category") {
    if (me.getBoOrderMeta().getConsiderSelectablePromotion() == '1' && Utils.isDefined(me.getLoSelectablePromotion().getCurrent())) {
      me.getLoItems().setItemFilter(currentItemFilter, categoryId, currentPromotion.getPKey());
    ...
    me.setCategoryQuickFilterCache(items[0].filterValue);
  }
}
else {
