...
var addItemsToLoProductCategoryFilter = function (items){
  ...
  for (var i=0; i<items.length; i++){
    ...
    var category = Utils.getToggleText("DomPrdCategory", categoryApiValue);
...
var selectedFilter;
//Reapply filter from either LoProductCategoryFilter or CategoryFilterCache (selectedFilter is API value for filtering)
